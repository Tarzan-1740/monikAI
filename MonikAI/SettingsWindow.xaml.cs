...
namespace MonikAI
{
    ...
    public partial class SettingsWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                foreach (var item in this.comboBoxLanguage.Items)
                {
                    if (item is string language && language.Equals(MonikaiSettings.Default.Language, StringComparison.InvariantCultureIgnoreCase))
                    {
                        this.comboBoxLanguage.SelectedItem = item;
                        break;
                    }
                }
            }
        ...
        {
            var restart = false;
            var selectedLanguage = (string) this.comboBoxLanguage.SelectedItem ?? this.comboBoxLanguage.Text;
            if (string.IsNullOrWhiteSpace(selectedLanguage))
            {
                selectedLanguage = MonikaiSettings.Default.Language;
            }

            if (!selectedLanguage.Equals(MonikaiSettings.Default.Language, StringComparison.InvariantCultureIgnoreCase))
            {
            ...
            MonikaiSettings.Default.Language = selectedLanguage;
